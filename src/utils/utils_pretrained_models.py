...
def set_parameter_requires_grad(model, feature_extracting: bool = True):
    """
    This method iterates over all parameters of the pretrained model and deactivates their requires_grad flag.
    ...
    :param feature_extracting: Purpose of the pretrained model. True if only to extract features, false otherwise.
    :return:
    """
...
def get_pretrained_model(
    ...
    :param num_output_features: The output dimension the model needs to have in order to fit the rest of the model.
    :param feature_extract: True, if pretrained model only extracts features but will not be trained, otherwise false.
    :param use_pretrained: When model is loaded, all pretrained parameters will be loaded as well, when True.
    :return:
    """

    if (pretrained_model == PretrainedModels.ResNet) or (pretrained_model in PretrainedModels.ResNet.value):
        """ 
        Model: Resnet152
        Model - Source: https://pytorch.org/docs/stable/torchvision/models.html#torchvision.models.resnet152
    ...
    elif (pretrained_model == PretrainedModels.VGG19) or (pretrained_model in PretrainedModels.VGG19.value):
        """
        Model: VGG19bn
        Model - Source: https://pytorch.org/docs/stable/torchvision/models.html#torchvision.models.vgg19_bn
    ...
    elif (pretrained_model == PretrainedModels.DenseNet) or (pretrained_model in PretrainedModels.DenseNet.value):
        """
        DenseNet 161
        Model: DenseNet 161
        Model - Source: https://pytorch.org/docs/stable/_modules/torchvision/models/densenet.html#densenet161
        ...
        raise ValueError('Wrong pretrained model / model name. Check spelling or use predefined enum.')
